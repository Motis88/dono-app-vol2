  ...
  return (
    <div className={`p-4 max-w-7xl mx-auto ${colors.text.primary}`}>
      ...
      <div className="flex justify-center mb-6">
        <div className={`flex items-center gap-2 ${colors.bg.tertiary} rounded-xl p-2 ${colors.border.primary} border`}>
          <button
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center">
          ...
          {(search || animalTypeFilter || dateFilter) && (
            <button
              ...
              className={`px-4 py-2 text-sm ${colors.bg.tertiary} hover:${colors.bg.tableRowHover} ${colors.text.primary} rounded-lg transition-colors duration-200 whitespace-nowrap`}
      ...
      <div className="block md:hidden space-y-4">
        {filteredDonors.length === 0 ? (
          ...
          filteredDonors.map((d, index) => (
            <div
              key={d.id}
              className={`${colors.bg.card} rounded-lg shadow-md border-l-4 p-4 cursor-pointer transition-all duration-200 hover:shadow-lg ${
          ...
          <table className="min-w-full text-sm">
            <thead className={`${colors.bg.tertiary} border-b ${colors.border.primary}`}>
              <tr>
                ...
                <th className={`px-4 py-3 text-center font-semibold ${colors.text.primary}`}>Actions</th>
